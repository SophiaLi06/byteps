"""
ResNet Network
Adapted from: https://github.com/danhdoan/cifar10-end2end-mxnet/blob/master/altusi/models/resnet.py
==============
"""
...
def get_resnet(block, layers, channels=3, nclasses=100):
...
resnet_archs = {
    ...
    50:  [BottleNeck, [3, 4, 6, 3],  [64,  64, 128,  256,  512]],
    101: [BottleNeck, [3, 4, 23, 3], [64,  64, 128,  256,  512]],
    152: [BottleNeck, [3, 8, 36, 3], [64,  64, 128,  256,  512]]
